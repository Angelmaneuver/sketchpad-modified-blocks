 ...
 * @return void
 */
function register_sketchpad_modified_block_file_data_display_get():void {
	sketchpad_modified_blocks_register_block_type_from_metadata(
		SMBROOT . SMBBLOCKS . '/file-data-display-by-get',
		array(
...
add_action( 'init', 'register_sketchpad_modified_block_file_data_display_get' );
