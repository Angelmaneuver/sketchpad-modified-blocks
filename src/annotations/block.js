 ...
 */
registerBlockType( 'sketchpad-modified-blocks/annotations', {
	...
	keywords: [
		__(
			'Sketchpad-modified-Blocks — Annotations Block',
			'sketchpad-modified-blocks'
		),
	...
	edit: ( { attributes, setAttributes, className } ) => {
		const updateSimbol = ( value ) => {
			setAttributes( { simbol: value } );
		};
	...
	save: ( { attributes, className } ) => {
		...
		return (
			<div style={ { background: attributes.backgroundColor } }>
				<p
					className="sketchpad-modified-blocks-annotations-simbol"
					style={ style }
				>
					<RichText.Content value={ attributes.simbol } />
				</p>
				<p
					className="sketchpad-modified-blocks-annotations-content"
					style={ style }
	...
	example: {
		attributes: {
			...
			content: __(
				'Annotations will be provided.<br />Second line.<br />Third line.',
				'sketchpad-modified-blocks'
			),
		},
	},
